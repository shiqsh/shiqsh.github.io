...
\section{Orbital Magnetization from Local Currents in the Wannier Representation}
...
\subsection{Single-band Insulator}

\subsection{Multi-band Insulator}


\section{Hatree-Fock Approach Method}
\subsection{Formalism}

\subsection{TBG with electron-electron interaction}


\section{Orbital Magnetization with Interaction}
\subsection{TBG} 

\subsection{Heterostrain}
